...
#engine =create_engine("sqlite:///C:\\Pri doc\\priti\\Projects\\Myproject\\Berkely\\week15-ploting graphs\\Instructions\\DataSets\\belly_button_biodiversity.sqlite",echo=True)
...
def getOtuDistribution(sample_number):
    ...
    labels = []
    values_raw = []
    #get top ten results so select those records
    for r in results[:10]:
        row = r.__dict__    
